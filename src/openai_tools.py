functions = [
    {"type": "function", "name": "get_conversation_summary",
     "function":
    {
        "description": "create conversation summary based on the conversation",
        "parameters": {
            "type": "object",
            "properties": {
