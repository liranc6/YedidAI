functions = [
     ...
     "function":
    {
        ...
        "description": "When the AI asked a few questions and receieved enough information to search Kolzchut, or the user has violated terms of usage ",
        "parameters": {
            "type": "object",
            "properties": {
                "reason": {
...
SYSTEM_PROMPT = \
    ...
    Your task is to gather information about the user until you have gathered enough information to pass on information to an agent who will search Kolzchut - reply up to 2 times before terminating.
